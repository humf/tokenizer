# Tokenizer [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0)[![Go.Dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/humf/tokenizer?tab=doc)[![Travis CI](https://api.travis-ci.org/humf/tokenizer.svg?branch=master)](https://travis-ci.org/humf/tokenizer)[![Go Report Card](https://goreportcard.com/badge/github.com/humf/tokenizer)](https://goreportcard.com/report/github.com/humf/tokenizer) 
...
All models can be loaded from files manually. [pkg.go.dev](https://pkg.go.dev/github.com/humf/tokenizer?tab=doc) for detail APIs.


## Getting Started

- See [pkg.go.dev](https://pkg.go.dev/github.com/humf/tokenizer?tab=doc) for detail APIs 
